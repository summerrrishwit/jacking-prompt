...
def translate_queries(input_file, output_file):
    ...
    for i, item in enumerate(data['queries']):
        ...
        try:
            ...
            translation = translator.translate(original_query, src='en', dest='zh-cn')
            translated_query = {
...
if __name__ == "__main__":
    INPUT_FILE = "dataset/queries/all_ai_queries_en.json"
    OUTPUT_FILE = "dataset/queries/all_ai_queries_zh.json"
